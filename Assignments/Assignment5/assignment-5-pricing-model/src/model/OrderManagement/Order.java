...
public class Order {
    ...
    public OrderItem newOrderItem(Product p, int actualprice, int q, CustomerProfile c) {
        OrderItem oi = new OrderItem(p, actualprice, q, c);
        orderitems.add(oi);
        return oi;
    }
    ...
    public void printOrderItemsShortInfo(){
        int itemNumber = 1; // Starting item number
